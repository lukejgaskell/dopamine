...
type EditScrollFormProps = {
  scroll: Scroll
  onClose: () => void
  onUpdated: () => void
}

export function EditScrollForm({ scroll, onClose, onUpdated }: EditScrollFormProps) {
    ...
    try {
      ...
      const modulesWithIdsAndDatasetId = formData.modules.map(module => {
        ...
        if (moduleWithId.type === 'dataset' || moduleWithId.type === 'brainstorm') {
          const moduleAny = moduleWithId as any
          return { ...moduleWithId, dataset_id: moduleAny.dataset_id || crypto.randomUUID() }
        } else {
          return moduleWithId
        }
      })
    ...
    <div className="fullscreen-modal-overlay">
      <div className="fullscreen-modal-content">
        ...
        <form onSubmit={handleSubmit} className="fullscreen-form">
          ...
          <div className="form-section">
            <h3>Load from Trend</h3>
            <p className="section-description">Select a trend to replace current modules</p>
