...
import '@/styles/trend-forms.css'

type EditTrendFormProps = {
  trend: Trend
  onClose: () => void
  onUpdated: () => void
}

export function EditTrendForm({ trend, onClose, onUpdated }: EditTrendFormProps) {
  ...
  const [formData, setFormData] = useState({
    name: trend.name,
    modules: (trend.modules || []) as ModuleConfig[],
  })
  ...
  const handleDelete = async () => {
    const confirmed = await confirm({
      title: 'Delete Trend',
      message: 'Are you sure you want to delete this trend? This action cannot be undone.',
      confirmLabel: 'Delete',
      cancelLabel: 'Cancel',
    })
